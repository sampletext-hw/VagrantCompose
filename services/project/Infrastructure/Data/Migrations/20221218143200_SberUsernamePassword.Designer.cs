...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20221218143200_SberUsernamePassword")]
    partial class SberUsernamePassword
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Db.DbOrder.Order", b =>
                {
                    ...
                    b.Property<int>("PostProcessingStatus")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Models.Db.DbRestaurant.Restaurant", b =>
                {
                    ...
                    b.Property<string>("SberbankPassword")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<string>("SberbankUsername")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<long>("SupportedPaymentTypes")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.Db.Payments.OnlinePayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.Db.Payments.OnlinePayment", b =>
                {
                    ...
                    b.HasOne("Models.Db.DbOrder.Order", "Order")
                        ...
                        .HasForeignKey("Models.Db.Payments.OnlinePayment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
